...
void createTeleopConfigFile(string &sExecutableName)
{
  ...
  displayCommandProgress((nIoResult == ioRsltSuccess) ? "Entering Tracking" : "Entering Config");
  return;
}
...
void doSingleOrDualModeSelection()
{
   ...
   bSingle = false;
   drawMenu(menuFromTop, iconNone, iconMyFiles, iconFileTypeExeFiles, "Config", sSelectModePrompt);
   while (true)
   {
      switch (nNxtButtonTransition)
      {
      ...
      case kLeftButton:
        ...
        if (!bSingle)
            drawMenu(menuFromRight, iconMyFiles, iconFileTypeExeFiles, iconNone, "Tracker", sSelectModePrompt);
        else
            drawMenu(menuFromLeft, iconNone, iconMyFiles, iconFileTypeExeFiles, "Config", sSelectModePrompt);
        bSingle = !bSingle;
        break;
      ...
      case kEnterButton:
        ...
        displayCommandProgress("Tracking");
          return;
        }
        else
        ...
        drawMenu(menuFromBottom, iconNone, iconMyFiles, iconFileTypeExeFiles, "Config", sSelectModePrompt);
        break;
