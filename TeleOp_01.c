...
#pragma config(Motor,  mtr_S1_C4_1,     motorRight,    tmotorTetrix, PIDControl, encoder)
...
#pragma config(Servo,  srvo_S1_C3_4,    servoClamp,            tServoStandard)
#pragma config(Servo,  srvo_S1_C3_5,    servoHook,           tServoStandard)
